...
CELERY_TIMEZONE = 'UTC'
CELERY_TASK_DEFAULT_QUEUE = env('SQS_QUEUE_NAME', default='clinic-tasks')

CELERY_BEAT_SCHEDULE = {
    'dispatch-reminders': {
        'task': 'appointments.tasks.dispatch_reminders',
        'schedule': crontab(minute='*/15'),
    },
}

DEFAULT_FROM_EMAIL = env('DEFAULT_FROM_EMAIL', default='noreply@liman.clinic')
